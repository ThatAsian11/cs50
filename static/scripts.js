...
function addMarker(place)
{
    ...
    // Custom marker icon
    var image = "http://maps.google.com/mapfiles/ms/micons/lightblue.png";
    ...
    $.getJSON("/articles", {geo: place.postal_code}, function(articles) {
        ...
        {			
            ...
            {
				// Each list item is stored in articlesContent
    ...
    // Add markers to map and store in array 'marker'
    markers.push(marker);
}
