...
An online ordering interface for Pinocchio's Pizza & Subs
...
Personal Touch: I added order confirmation emails sent using gmail's smtp service. forms.py defines the Form class for the user registration form.
